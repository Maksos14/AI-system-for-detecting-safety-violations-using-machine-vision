...
Проект предназначен для автоматического контроля за соблюдением техники безопасности на производстве, стройке или любом другом объекте, где требуется использование СИЗ (средств индивидуальной защиты).

## Основная цель — снизить риск травматизма и повысить безопасность сотрудников за счет автоматического видео-контроля и мгновенного оповещения о нарушениях.

Что именно проверяет система в реальном времени через камеру?
 Защитные каски
 Сигнальные жилеты
 Защитные маски (например, медицинские или респираторы)

## Как работает:
Камера (обычная USB, встроенная или смартфон) следит за сотрудниками в кадре.

Нейросеть в реальном времени определяет людей и наличие на них необходимой защиты.

Если человек находится без каски, жилета или маски более 10 секунд:

 Срабатывает звуковой сигнал
 Делается скриншот нарушения
 Фото сохраняется в папку violations/ для отчетности
...
Любые зоны с обязательным использованием СИЗ
